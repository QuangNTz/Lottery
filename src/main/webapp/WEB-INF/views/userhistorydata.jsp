		...
		<div class="tab-content">
			...
			<div class="pages-nav">				
				<form class="d-flex" action="search_userhistorydata">
					<table>
						<tr>					      	
							<td><input type="search" class="form-control me-2" name="usr_search" placeholder="CTXS - kết quả dò số" aria-label="Search"></td>
				...
				<ul class="pagination justify-content-center">
					<c:forEach begin="1" end="${sessionScope.hisMap.endPage}" var="i">
						<li class="page-item ${sessionScope.hisMap.activePage == i ? 'active' : '' }" aria-current="${sessionScope.hisMap.activePage == i ? 'page' : '' }">
							<a class="page-link" href="/Lottery/loaduserhistorydata?history_scope=${sessionScope.history_scope}&page=${i}">${i}</a>
						</li>
					</c:forEach>
				</ul>				
			</div>
